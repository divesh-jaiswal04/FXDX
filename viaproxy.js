...
const main = async () => {
  ...
  const proxyContract = new web3.eth.Contract(engineABI, proxyAddress);


  const commitOrderData = proxyContract.methods.commitOrder(
    perpsMarketId,
    accountId,
    sizeDelta,
  ...
  const multicallData = proxyContract.interface.encodeFunctionData(
    'multicall',
    [
  ...
  const tx = {
    ...
    to: proxyAddress,
    data: multicallData,
    gasLimit: ethers.utils.hexlify(250_000),
    gasPrice: 3000000,
  };
